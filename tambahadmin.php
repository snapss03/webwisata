...
<head>
    ...
    <title>Tambah Admin | Wisata Punya Siapa</title>
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-danger sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="dashboard.php">
                ...
                <div class="sidebar-brand-text mx-1">Wisata Punya Siapa</div>
            </a>
            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="paket.php">Paket Wisata</a>
            ...
            <div id="content">
                ...
                <h1 class="h3 mb-2 text-gray-800">Form Tambah Data Admin</h1>
                    <form method="POST" action="tadmin.php">
                        <div class="mb-3 row">
                            <label for="inputEmail3" class="col-sm-2 col-form-label">Id Admin</label>
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="inputEmail3" name="id_admin">
                            </div>
                        </div>
                        <div class="mb-3 row">
                        ...
                        <div class="mb-3 row">
                            <label for="inputtelp3" class="col-sm-2 col-form-label">No Telefon</label>
                            <div class="col-sm-10">
                                <input type="mediumint" class="form-control" id="inputEmail3" name="no_telefon">
                            </div>
                        </div>
                        <div class="mb-3 row">
